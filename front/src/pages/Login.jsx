      ...
      <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl">
        ...
        <div className="w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center ">
          <div className="w-full flex gap-2 items-center mb-6">
            <div className="p-2 bg-[#FFA500] rounded text-white">
              <TbSocial />
            </div>
            <span className="text-5xl font-bold">
              <span className="text-orange">Friend</span>
          ...
          <form
            ...
            {isSubmitting ? (
              ...
              <CustomButton
                type="submit"
                containerStyles={`inline-flex justify-center rounded-full bg-orange px-8 py-3 mt-3 text-sm font-medium text-white outline-none`}
                title="Login"
              />
            )}
          </form>
        ...
        {/* RIGHT */}
        <div className="hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-orange">
